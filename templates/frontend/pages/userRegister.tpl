...
<div class="page page_register">
    ...
    <form class="cmp_form register" id="register" method="post" action="{url op="registerUser"}">
            ...
            <div class="fields">
                <div class="optin optin-privacy">
                    <label class="inp-item inp-item--checkbox">
                        <input type="checkbox" name="ageLimit" value="1"{if $ageLimit} checked="checked"{/if}>
                        <span class="label">{translate key="user.register.form.ageLimit"}
        ...
        <legend>
            <h3>
                {translate key="user.register.form.privacyConsent.title"}
            </h3>
        </legend>
        <div class="gdpr">
            <p>
                {translate key="registration.gdpr"}
            </p>
        </div>
        <br />
        <fieldset class="consent">
            ...
            <div class="fields">
                <div class="optin optin-privacy">
                    ...
                    <span class="label">{translate key="user.register.form.privacyConsent" privacyUrl=$privacyUrl}
                        <span class="required required--asterisk">*</span>
                        <span class="pkp_screen_reader">
                            {translate key="common.required"}
                        </span>
