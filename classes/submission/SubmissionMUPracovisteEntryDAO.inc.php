...
/**
 * @file classes/submission/SubmissionMUPracovisteEntryDAO.inc.php
 *
 * Copyright (c) 2014 Simon Fraser University Library
 * Copyright (c) 2000-2014 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class SubmissionMUPracovisteEntryDAO
 * @ingroup submission
 * @see Submission
 *
...
import('lib.pkp.classes.submission.SubmissionMUPracoviste');
import('lib.pkp.classes.controlledVocab.ControlledVocabEntryDAO');

class SubmissionMUPracovisteEntryDAO extends ControlledVocabEntryDAO {
	/**
	 * Constructor
	 */
	function SubmissionMUPracovisteEntryDAO() {
		parent::ControlledVocabEntryDAO();
	}

	/**
	 * Construct a new data object corresponding to this DAO.
	 * @return submissionMUPracoviste
	 */
	function newDataObject() {
		return new SubmissionMUPracoviste();
	}
