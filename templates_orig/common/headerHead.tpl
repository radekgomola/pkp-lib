...
{*            Počítání velikosti sloupců v divech.*}
        ...
        <script src="{$baseUrl}/js/munipress/jscroll-master/jquery.jscroll.min.js"></script>
        
{*        Orbit Foundation*}
        <link rel="stylesheet" href="{$baseUrl}/js/foundation/css/foundation.css">
        <link rel="stylesheet" href="{$baseUrl}/js/foundation/css/app.css">
